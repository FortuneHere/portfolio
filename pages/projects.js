  ...
  return (
    <Container>
      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        <Section delay={0.1}>
        <WorkGridItem id="todoTsx" title="Todo.tsx" thumbnail={thumbTodoTsx}>
          Simple todo list with drag and drop
        </WorkGridItem>
        </Section>

        <Section delay={0.3}>
          <WorkGridItem id="catsApp" title="Cats app" thumbnail={thumbCatsApp}>
            Watch cats pictures and save them to your favourites
          </WorkGridItem>
        </Section>
        
        <Section delay={0.5}>
          <WorkGridItem id="responsiveWebSite" title="Landing web site" thumbnail={thumbReactResponsive}>
        ...
        <Section delay={0.7}>
          <WorkGridItem id="food" title="Food website" thumbnail={thumbFood}>
            Website made on pure javascript. Contains callory calculator, modal window, carousell
          </WorkGridItem>
        </Section>
